...
export function MovableLoginSection() {
  ...
  return (
    ...
    >
      ...
      <div className="mb-6 pt-3">
        <p className="mb-2 text-xs font-semibold uppercase tracking-[0.18em] text-primary">Anime Azərbaycan</p>
        <h1 className="font-display text-3xl font-bold text-text-primary">Daxil ol</h1>
        <p className="mt-2 text-sm text-text-secondary">
          Hesabına keç və izləmə siyahını, favorilərini və rəylərini davam etdir.
        </p>
      </div>
      ...
      <div className="mt-6 border-t border-white/10 pt-5">
        <p className="text-sm text-text-secondary">Hələ hesabın yoxdur?</p>
        <Link
          href="/auth/register"
